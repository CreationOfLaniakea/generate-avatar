...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-0">
      <div
        ...
        <div className="container mx-auto mt-8 px-4 py-2 bg-white rounded-lg shadow">
          <h1 className="font-extrabold text-2xl lg:text-4xl tracking-tight mb-2">
            How-To Craft your Avatar Icon
          </h1>
          <p className="text-sm lg:text-base opacity-80 leading-relaxed mb-4">
            Follow these steps to create your own unique avatar using Generate-Avatar.com, an AI-driven tool that crafts
            your avatar based on your descriptions.
          </p>

          <div className="space-y-2">
            <div className="p-4 bg-gray-50 border-l-2 border-blue-400">
              <h2 className="font-bold text-lg mb-1">Step 1: Get Started</h2>
              <p className="text-sm leading-relaxed">Click on the <span className='font-semibold text-red-500'>'Get Started'</span> button
                located at the top right corner of the homepage.</p>
            </div>

            <div className="p-4 bg-gray-50 border-l-2 border-blue-400">
              <h2 className="font-bold text-lg mb-1">Step 2: Enter Your Prompt</h2>
              <p className="text-sm leading-relaxed">Type a prompt in the input box labeled <span
                  className="font-semibold text-red-500">'Enter a prompt to display an avatar'</span>.</p>
            </div>

            <div className="p-4 bg-gray-50 border-l-2 border-blue-400">
              <h2 className="font-bold text-lg mb-1">Step 3: Generate the Avatar</h2>
              <p className="text-sm leading-relaxed">Click the <span
                  className="text-blue-500 font-semibold">'GO!'</span> button after entering your prompt. Ensure you are
                logged in, as this button is only active for logged-in users.</p>
            </div>


            <div className="p-4 bg-gray-50 border-l-2 border-blue-400">
              <h2 className="font-bold text-lg mb-1">Step 4: Save or Share</h2>
              <p className="text-sm leading-relaxed">Once satisfied, save your avatar to your device or share it on
                social media platforms directly from the website.</p>
            </div>
      ...
      <div className="flex flex-col w-full">
        ...
        <Image
            src="/avatar_display/example.webp"
            alt="avator example"
            className="w-full ml-auto rounded-full object-cover"
            priority={true}
            width={500}
            height={500}
        />
